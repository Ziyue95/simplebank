...
func TestInvalidJWTTokenAlgNone(t *testing.T) {
	...
	// pass jwt.UnsafeAllowNoneSignatureType as the secret key to enable use None algorithm to sign token
